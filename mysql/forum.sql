...
) ENGINE=InnoDB AUTO_INCREMENT=1001346 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`maxim`@`localhost`*/ /*!50003 TRIGGER `forum`.`Post_BEFORE_INSERT` BEFORE INSERT ON `Post` FOR EACH ROW
BEGIN
	DECLARE next_id INT;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`maxim`@`localhost`*/ /*!50003 TRIGGER `forum`.`Post_AFTER_INSERT` AFTER INSERT ON `Post` FOR EACH ROW
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`maxim`@`localhost`*/ /*!50003 TRIGGER `forum`.`Post_AFTER_UPDATE` AFTER UPDATE ON `Post` FOR EACH ROW
BEGIN
...
) ENGINE=InnoDB AUTO_INCREMENT=11207 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `User` (
  ...
  UNIQUE KEY `id_UNIQUE` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100994 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`maxim`@`localhost`*/ /*!50003 TRIGGER `forum`.`User_AFTER_UPDATE` AFTER UPDATE ON `User` FOR EACH ROW
BEGIN
...
-- Dump completed on 2016-01-22 18:10:44
